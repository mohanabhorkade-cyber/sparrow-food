...
export class HomeComponent implements OnInit {
  ...
  productCategories: ProductCategory[] = [
    ...
    { title: 'Flavours (Liquid & Spray Dried Powder)', description: 'Premium Flavours & Natural Extracts', image: 'assets/images/optimized/Main_Flavours_Extracts1.webp', queryGroup: 'Flavours (Liquid & Spray Dried Powder)' },
    ...
    { title: 'Instant Drink Beverage Premixes', description: 'Refreshing Instant Beverage Mixes', image: 'assets/images/optimized/Instant_Drink_Beverage_Premixes.webp', queryGroup: 'Instant Drink Beverage Premixes' },
    { title: 'Mixes for Cocktail Beverages', description: 'Exotic & Tangy Cocktail Range', image: 'assets/images/optimized/mixes_cocktail.webp', queryGroup: 'Mixes for Cocktail Beverages' },
    ...
    { title: 'Beverage Ingredients/Additives - A.Carbonated Soft Drink (CSD)', description: 'Premium Ingredients for Carbonated Drinks', image: 'assets/images/optimized/brevarage_ingradienceA.webp', queryGroup: 'Beverage Ingredients/Additives - A.Carbonated Soft Drink (CSD)' },
    ...
    { title: 'Food Colours', description: 'Texture, Colour & Flavour Solutions', image: 'assets/images/optimized/food_colors.webp', queryGroup: 'Food Colours' }
  ];
